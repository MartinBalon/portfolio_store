...
const Intro = () => {
    return (
        <div className="xs-w-90 s-w-80 xs-m-t-10 xs-m-b-10 m-m-b-5 m-m-t-5 m-cw intro clearfix">
            <div>
                <h1 className="xs-fs-2em xs-m-b-5">
                    High resolution aluminium prints have never been more affordable!
                </h1>
            </div>
            <div>
